  ...
  data() {
    return {
      integrations: [
        ...
        {
          title: 'Cube Chain',
          name: 'partner_cube-chain',
          link: 'https://www.cubechain.io/',
          scale: 0.8,
          brightness: 1,
        },
        {
          title: 'Ethereum',
          name: 'partner_ethereum',
