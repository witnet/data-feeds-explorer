...
describe('getRangeData', () => {
  test('getWeeklyData', () => {
    ...
    expect(getRangeData(data, RANGE_DATA.week)).toStrictEqual(expected)
  })
  test('getMonthlyData', () => {
    const data = [
      { time: '2018-10-19', value: '26.19' },
    ...
    expect(getRangeData(data, RANGE_DATA.month)).toStrictEqual(expected)
  })
  test('getYearlyData', () => {
    const data = [
      { time: '2018-10-19', value: '26.19' },
    ...
    expect(getRangeData(data, RANGE_DATA.year)).toStrictEqual(expected)
  })
})
